        ...
        <div class="row">
            <div class="col-12 my-5">
                <div class="card">
                    <div class="card-body">
                    <div class="container-fluid">
                        <label for="search" class="fw-bold mb-2 px-1">Masukkan Kodemu disini</label>
                        <div class="col-12 d-flex">
                            <input type="text" id="search" class="form-control w-100" placeholder="Kode Order">
                            <button id="btn-search" class="btn btn-primary mx-2"><i class="lab la-get-pocket"></i></button>
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="col-12 my-5">
                <div class="card">
                    <div class="card-body">
                        <h3 class="fw-bold pt-3 px-4 mb-3">Data Tiketmu</h3>
                        <div class="container-fluid">
                            <div class="table-responsive">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            if(isset($_GET['q'])) {
                                                $selOrder = mysqli_query($konek,"SELECT * FROM vwtransaksi WHERE kode_order = '$_GET[q]'");
                                                $no = 1;
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="../db/hapusOrder.php?i=<?=$row['id_order']?>" class="btn btn-danger mt-1 mt-md-0"><i class="las la-check-circle"></i></a>
                                                        </td>
                                                    </tr>
                                        <?php
                                                }
